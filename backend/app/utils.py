...
def calculate_lead_score(model, data):
    ...
    feature_names = ['quote_value', 'item_count', 'conversion_days']
...
def generate_email_llama2(customer_name, lead_score, quote_value, item_count, use_case_id=None, company_name=None, customer_email=None):
...
Format the email with these headers at the top:
